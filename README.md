...
**Development status: 0.5.30 — sub-map (SMS) scorer added; cross-version CI fixes (subplugin plugininfo class, subplugins.json dual format). Verified on real Moodle 4.5.12 AND 5.0.8 instances.**
