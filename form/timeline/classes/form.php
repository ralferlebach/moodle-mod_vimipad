...
namespace vimipadform_timeline;

/**
 * Form definition for the Timeline display type.
 *
 * Events flow left to right along a single time line: the layout is directed
 * along +x and confines nodes onto one horizontal line.
 *
...
class form extends \mod_vimipad\local\form\base {
    ...
    /**
     * Time flows left to right: directed edges are aligned along +x.
     *
     * @return array|null
     */
    ...
    /**
     * Timelines treat relations as directed (earlier to later).
     *
     * @return bool
     */
    ...
    /**
     * Events are confined onto one horizontal line (parallel to +x).
     *
     * @return array|null
     */
