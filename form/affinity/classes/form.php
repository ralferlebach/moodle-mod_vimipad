...
namespace vimipadform_affinity;

/**
 * Form definition for the Affinity board display type.
 *
 * Free notes grouped into clusters (containers): undirected, no imposed order;
 * on arrange each container's members cohere toward their cluster centroid.
 *
...
class form extends \mod_vimipad\local\form\base {
    ...
    /**
     * Members of each container cohere toward their cluster centroid.
     *
     * @return bool
     */
