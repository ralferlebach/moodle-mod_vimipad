...
/**
 * External function: start the group-consensus submission process.
 *
 * @package    mod_vimipad
 * @copyright  2026 Ralf Erlebach
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class start_consensus extends external_api {
    /**
    ...
    /**
     * Start the process and return the resulting status.
     *
    ...
    public static function execute(int $cmid, int $groupid = 0): array {
        ...
        $result = (new consensus_service())->start($instance, $workspace, $context, (int) $USER->id);
