...
/**
 * The mod_vimipad snapshot graded event.
 *
 * Fired when a teacher saves a grade against a submitted snapshot.
 *
 * @package    mod_vimipad
 * @copyright  2026 Ralf Erlebach
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class snapshot_graded extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('event:snapshot_graded', 'mod_vimipad');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' graded the snapshot with id '{$this->objectid}' " .
